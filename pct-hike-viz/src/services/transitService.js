...
export const transitRoutes = [
  ...
  },
  {
    ...
    notes: "Pickup time is set through the final inReach check-in protocol. Call McCloud Ranger Station at 530-964-2184 before committing the Kia Sportage to FS Road 38N11.",
